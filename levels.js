...
(function setupLevelsModule(window) {
  ...
  const BATTLE_SCENARIO_WAVE_ARCS = Object.freeze({
    "death of a close family member": [
      "Shock and Numbness",
      "Waves of Grief",
      "Holding On for Grace and Steady Ground",
    ],
    "death of a spouse": [
      "Empty Home Silence",
      "Identity and Loneliness",
      "Holding On for Grace in Relearning Life",
    ],
    "divorce": [
      "Acute Grief",
      "Isolation and Uncertainty",
      "Fighting for Healing, Wisdom, and Peace",
    ],
    "ongoing marital conflict": [
      "Escalating Tension",
      "Emotional Exhaustion",
      "Standing Firm for Grace, Repair, and Forgiveness",
    ],
    "loss of a job": [
      "Sudden Instability",
      "Fear and Self-Doubt",
      "Fighting for Grace and New Direction",
    ],
    "long-term unemployment": [
      "Discouragement Loop",
      "Identity and Shame",
      "Fighting for Renewed Hope and Daily Strength",
    ],
    "severe financial hardship": [
      "Constant Pressure",
      "Scarcity and Anxiety",
      "Fighting for Provision and Steady Ground",
    ],
    "foreclosure or loss of a home": [
      "Displacement Shock",
      "Loss of Security",
      "Fighting for Shelter, Stability, and Hope",
    ],
    "chronic illness": [
      "Ongoing Symptoms",
      "Fatigue and Frustration",
      "Holding On for Strength for Today",
    ],
    "caring for a terminally ill loved one": [
      "Anticipatory Grief",
      "Caregiver Burnout",
      "Holding On for Grace and Meaningful Presence",
    ],
    "mental health struggles": [
      "Inner Turbulence",
      "Isolation Spiral",
      "Holding On for Light, Help, and Hope",
    ],
    "addiction": [
      "Cravings and Triggers",
      "Consequences and Shame",
      "Fighting for Accountability, Grace, and Recovery",
    ],
    "relapse after recovery": [
      "Setback and Despair",
      "Honest Reflection",
      "Fighting Back for Grace and Restoration",
    ],
    "caring for an aging parent": [
      "Growing Demands",
      "Compassion Fatigue",
      "Fighting for Shared Care and Daily Grace",
    ],
    "parenting a child with special needs": [
      "Daily Overload",
      "Advocacy Fatigue",
      "Fighting for Daily Grace and Sustainable Support",
    ],
    "parenting a troubled child": [
      "Crisis and Conflict",
      "Fear and Helplessness",
      "Fighting for Faithful Steps and Renewed Hope",
    ],
    "betrayal by a close friend": [
      "Shock and Anger",
      "Trust Collapse",
      "Holding On for Forgiveness and Wise Boundaries",
    ],
    "deep loneliness": [
      "Silent Isolation",
      "Worth and Belonging",
      "Holding On for Belonging and Renewed Hope",
    ],
    "workplace hostility": [
      "Ongoing Strain",
      "Fear and Hypervigilance",
      "Standing Firm for Clarity, Courage, and Peace",
    ],
  });
