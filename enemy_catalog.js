(function(global) {
  const ENEMY_CATALOG = {
    ...
    priest: {
      ...
      bossTier: 1,
      preferredTarget: "player",
      specialBehavior: ["support"]
    },
    wizard: {
      displayName: "Wizard",
      assetFiles: { death: "DEATH" },
      assetFolder: "Wizard",
    ...
    miniFireImp: {
      ...
      bossTier: 0,
      preferredTarget: "player",
      specialBehavior: ["mini", "projectile"]
    },
    miniDemoness: {
    ...
    miniDemonLord: {
      ...
      bossTier: 3,
      preferredTarget: "player",
      specialBehavior: ["mini", "boss", "heavy"]
    },
    ...
    miniGhost: {
      ...
      bossTier: 0,
      preferredTarget: "npc",
      specialBehavior: ["mini", "targetsNPCs"]
    },
    miniLich: {
      displayName: "Lich",
  ...
  ns.list = Object.keys(ENEMY_CATALOG);
  ns.get = (key) => ENEMY_CATALOG[key] || null;
